...
// 3의 배수 확인
console.log(15 % 3) // 3의 배수가 맞음
console.log(13 % 3) // 3의 배수가 아님
console.log(27 % 3) // 3의 배수가 맞음
...
console.log(10**2) // 10의 제곱

// Math.pow()와 동일
// 수학(Math) 객체
console.log(Math.pow(2, 8) === 2 ** 8) // 2의 8제곱와 아
...
// 직접 평가 가능한 표현식으로 구성(평가 값 : Boolean)
// 조건 A : 온도 >= 18 (temperature >= 18)
// 조건 B : 온도 <= 26 (temperature <= 26)
// 조건 A 그리고 조건 B (A&&B)
// keep_fresh = temperature>=18 && temperature<=26
