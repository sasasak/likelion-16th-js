...
console.log(typeof 'JavaScript')      // 예측 값 작성: JavaScript
...
// 답: null의 타입태그도 000이어서 객체의 타입 태그와 동일하게 취급되는 버그가 있음.
...
// 질문: 결과가 다른 이유는 무엇인가요?
// 답: 문자열에서 + 연산을 하게 되면 산술이 아니라 문자열 연결로 이루어지기 때문이다. 
...
// 답: Number 타입이 아니라 BigInt 형임을 명시적으로 알리기 위해서
...
// 답: 다르다. Symbol 로 선언된 변수는 이름이 같더라도 고유한 값을 가진다. 